...
interface NewWorkOrderEmailTemplateProps {
	workOrder: {
		otNumber: string
		type: string
		priority: string
...
const NewWorkOrderEmailTemplate = ({ workOrder }: NewWorkOrderEmailTemplateProps) => {
...
export default NewWorkOrderEmailTemplate
