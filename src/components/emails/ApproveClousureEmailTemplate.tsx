...
export const ApproveClousureEmailTemplate: React.FC<Readonly<ApproveClosureEmailTemplateProps>> = ({
	workOrderName,
	workOrderNumber,
	companyName,
	supervisorName,
	...
	<Html>
		<Tailwind>
			<Head>
				<title>Cierre de Libro de Obras Aprobado - OTC 360</title>
				...
				<Container className="mx-auto max-w-[600px] rounded-[8px] bg-white p-[40px]">
					...
					<Section>
						...
						<Text className="mb-[24px] text-[16px] text-gray-600">
							Le informamos que su solicitud de cierre ha sido <strong>aprobada</strong>.
						</Text>
