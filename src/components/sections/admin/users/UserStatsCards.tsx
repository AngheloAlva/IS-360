...
import { UserWorkOrdersChart } from "./user-work-orders-chart"
import { DocumentActivityChart } from "./user-area-chart"
	...
	return (
		<div className="space-y-4">
			...
			<div className="grid gap-4 xl:grid-cols-2">
				...
				<DocumentActivityChart data={userData?.charts.documentActivity || []} />
			</div>
		</div>
	)
}
