...
import { MaintenancePlanBasicStats } from "@/hooks/maintenance-plans/use-maintenance-plan-stats"

import { Card, CardContent, CardHeader, CardTitle } from "@/components/ui/card"

interface MaintenancePlanStatsCardsProps {
	stats: MaintenancePlanBasicStats
}

export default function MaintenancePlanStatsCards({ stats }: MaintenancePlanStatsCardsProps) {
	return (
