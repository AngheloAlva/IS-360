...
function MenubarTrigger({
	...
	return (
		<MenubarPrimitive.Trigger
			...
			className={cn(
				"hover:bg-muted aria-expanded:bg-muted flex items-center rounded-sm px-1.5 py-0.5 text-sm font-semibold outline-hidden select-none",
				className
			)}
			{...props}
		/>
...
function MenubarLabel({
	...
	return (
		<MenubarPrimitive.Label
			...
			data-inset={inset}
			className={cn("px-1.5 py-1 text-sm font-semibold data-inset:pl-7", className)}
			{...props}
		/>
	)
}
