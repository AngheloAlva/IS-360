	...
	(
		...
		return (
			...
			>
				<div
					className={cn(
						"focus-within:border-ring focus-within:ring-ring/50 aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive border-input relative min-h-9.5 rounded-md border text-sm text-neutral-700 transition-[color,box-shadow] outline-none focus-within:ring-[3px] has-disabled:pointer-events-none has-disabled:cursor-not-allowed has-disabled:opacity-50",
						{
						...
						{selected.map((option) => {
							return (
								<div
									key={option.value}
									className={cn(
										"animate-fadeIn bg-background text-secondary-foreground hover:bg-background relative inline-flex h-fit cursor-default items-center rounded-md border py-0.5 ps-2 pe-7 pl-2 text-xs font-medium transition-all disabled:pointer-events-none disabled:cursor-not-allowed disabled:opacity-50 data-fixed:pe-2",
										badgeClassName
									)}
														...
														return (
															...
															>
																{(() => {
																	...
																	const primaryLabel =
																		separatorIndex >= 0
																			? option.label.slice(0, separatorIndex)
																			: option.label
																	const secondaryLabel =
																		separatorIndex >= 0
																			? option.label.slice(separatorIndex + 1)
																			: ""

																	return (
																		<span className="min-w-0 text-sm leading-snug font-semibold wrap-break-word">
																			{primaryLabel}
																			{secondaryLabel ? (
																				<span className="text-primary/90 text-[0.8em] font-medium">
																					{secondaryLabel}
																				</span>
																			) : null}
																		</span>
