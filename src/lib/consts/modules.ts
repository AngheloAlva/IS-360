...
export const ModulesValuesArray = [
	...
	MODULES.EQUIPMENT_HISTORY, // Historial de Equipos
	...
	MODULES.PROGRAMATION, // Programación
...
export const ModuleOptions = [
	...
	{
		value: MODULES.EQUIPMENT_HISTORY,
