import { BasicDocumentType, DocumentCategory } from "@/generated/prisma/enums"
...
export const BASIC_FOLDER_STRUCTURE: BasicStartupFolderStructure = {
	...
	description: "Documentación básica para que el trabajador pueda desempeñar sus funciones en la planta.",
	documents: [
		{
		...
		},
		{
			...
			description:
				"Inducción sobre Información de riesgos laborales (DS44), la cual debe incluir, los riesgos a los que se podría estar expuesto en la planta y las respectivas medidas de control.",
		},
		{
