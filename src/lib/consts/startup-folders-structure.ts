...
export const SAFETY_AND_HEALTH_STRUCTURE: StartupFolderStructure = {
	...
	documents: [
		...
		{
			type: SafetyAndHealthDocumentType.CONTRACTOR_REGULATION_RECEIPT,
			name: "Registro de recepción del reglamento de contratistas",
			description:
				"Documento que acredita la recepción del reglamento de contratistas. (Descargar reglamento para llenar y firmar)",
		},
	],
}
