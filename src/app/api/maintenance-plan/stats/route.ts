...
import { PLAN_FREQUENCY, WORK_ORDER_PRIORITY } from "@/generated/prisma/enums"
...
export async function GET() {
	...
	try {
		...
		// 5. Datos para gráfico de tareas cumplidas por mes (todas las OTs completadas de todos los planes)
		...
		const monthlyCompletedStats = Array.from(monthsMap.entries())
			.map(([date, count]) => {
