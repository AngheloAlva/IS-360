...
import { workPermitSelect, flattenWorkPermit } from "@/lib/api-v1/mappers/work-permit"
...
export async function GET(request: NextRequest) {
  ...
  try {
    ...
    return buildPaginatedResponse({
      data: data.map(flattenWorkPermit),
    ...
    console.error("[API_V1_WORK_PERMITS]", error)
