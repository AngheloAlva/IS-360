...
export default function DashboardHomePage() {
	...
	return (
		<div className="flex w-full flex-col gap-8">
			<div className="relative flex h-87.5 items-start justify-start overflow-hidden rounded-lg p-5 shadow">
				<Image
					fill
					priority
					alt="Dashboard Hero"
				...
				/>
				<div className="absolute inset-0 bg-linear-to-t from-black/80 to-transparent sm:bg-linear-to-tl" />

				<div className="relative z-10 flex h-full w-full flex-col items-end justify-end text-right text-white">
					<h1 className="text-3xl font-bold drop-shadow-2xl md:text-4xl">Bienvenido a IS 360</h1>
