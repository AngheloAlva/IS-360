	...
	return (
		<div className="w-full flex-1 space-y-4">
			<ModuleHeader
				...
				className="rounded-lg bg-linear-to-r from-orange-600 to-amber-500 p-6 shadow-lg"
			>
				<>
			...
			<div className="grid gap-4 md:grid-cols-3">
				<Card>
					<CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
						<CardTitle className="text-sm font-semibold">Total Herramientas</CardTitle>
				...
				<Card>
					<CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
						<CardTitle className="text-sm font-semibold">En Uso</CardTitle>
				...
				<Card>
					<CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
						<CardTitle className="text-sm font-semibold">Actividades Hoy</CardTitle>
