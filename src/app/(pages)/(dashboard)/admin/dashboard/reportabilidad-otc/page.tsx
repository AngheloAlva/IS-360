...
import { DatabaseZapIcon, HandshakeIcon } from "lucide-react"
...
type DashboardId = "dashboard1" | "dashboard2"
...
export default function PowerBIDashboardPage() {
	...
	const [dashboards, setDashboards] = useState<DashboardsMap>({
		dashboard1: {
			...
			url: "https://app.powerbi.com/view?r=eyJrIjoiNDQwODQzMDItMDI0OC00MWY4LWE1NTEtOGQyNjVlMWZhNDk0IiwidCI6IjEwM2FjNTc1LTRhYmQtNDVjYi1iOGI4LWJjMjViY2IwNThiNSJ9",
	...
	useEffect(() => {
		...
		const canSeeDashboard2 = session.data?.user.id === "Uyzgf9lJ2xIot9MAGxSKlNkjLpot51iF"
	...
	return (
		<div className="flex h-full w-full flex-1 flex-col gap-4 overflow-hidden transition-all">
			<div className="rounded-lg bg-linear-to-r from-blue-600 to-green-600 p-6 dark:from-blue-800 dark:to-green-800">
