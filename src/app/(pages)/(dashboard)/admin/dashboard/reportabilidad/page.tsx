...
import { BuildingIcon, DatabaseZapIcon, HandshakeIcon, StarIcon } from "lucide-react"
...
export default function PowerBIDashboardPage() {
	...
	const [dashboards, setDashboards] = useState<DashboardsMap>({
		...
		dashboard2: {
			title: "Reporte Hualpen",
			url: "https://app.powerbi.com/view?r=eyJrIjoiOTYyYTJiNzQtZTM5YS00NTg0LTgxZWMtNGFkOTk2M2E1YjZlIiwidCI6IjEwM2FjNTc1LTRhYmQtNDVjYi1iOGI4LWJjMjViY2IwNThiNSJ9",
