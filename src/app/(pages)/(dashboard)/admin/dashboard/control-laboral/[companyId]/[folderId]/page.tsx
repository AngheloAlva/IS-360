...
import { LaborControlFolderStatusBadge } from "@/project/labor-control/components/data/LaborControlFolderStatusBadge"

import { getFolderStatusByCompany } from "@/project/labor-control/actions/get-folder-status-by-company"
...
export default async function StartupFolderReviewPage({
	...
	const { companyAccreditationStatus, workerAccreditationStatus } = await getFolderStatusByCompany({
		folderId,
	})
					...
					<Table className="bg-background">
						...
						<TableBody>
							<TableRow>
								...
								<TableCell>
									<LaborControlFolderStatusBadge status={companyAccreditationStatus} />
								</TableCell>
							</TableRow>
							<TableRow>
								<TableCell>
								...
								<TableCell>
									<LaborControlFolderStatusBadge status={workerAccreditationStatus} />
								</TableCell>
							</TableRow>
						</TableBody>
					</Table>
