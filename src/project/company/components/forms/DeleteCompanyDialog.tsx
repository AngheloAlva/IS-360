...
export default function DeleteCompanyDialog({ companyId }: { companyId: string }) {
	...
	return (
		<AlertDialog open={open} onOpenChange={setOpen}>
			...
			<AlertDialogContent>
				<AlertDialogHeader>
					...
					<AlertDialogDescription>
						¿Estás seguro de querer desactivar esta empresa?
						<br />
						Recuerda que una vez desactivada, esto hará que la empresa no pueda ser utilizada en
       ...
       void handleDeleteCompany()
					...
					>
						{isLoading ? <Spinner className="h-4 w-4" /> : "Desactivar"}
					</AlertDialogAction>
				</AlertDialogFooter>
			</AlertDialogContent>
		</AlertDialog>
