...
export const vehicleColumns: ColumnDef<Vehicle>[] = [
	...
	{
		accessorKey: "plate",
		header: ({ column }) => <DataGridColumnHeader column={column} title="Matricula" visibility />,
		meta: {
	...
	{
		accessorKey: "model",
		header: ({ column }) => <DataGridColumnHeader column={column} title="Modelo" visibility />,
		meta: {
			headerTitle: "Modelo",
		},
	},
	{
		accessorKey: "year",
		header: ({ column }) => <DataGridColumnHeader column={column} title="Ano" visibility />,
		meta: {
			headerTitle: "Ano",
		},
	},
	{
		accessorKey: "brand",
		header: ({ column }) => <DataGridColumnHeader column={column} title="Marca" visibility />,
		meta: {
			headerTitle: "Marca",
		},
	},
	{
		accessorKey: "type",
		header: ({ column }) => <DataGridColumnHeader column={column} title="Tipo" visibility />,
		meta: {
			headerTitle: "Tipo",
		},
		cell: ({ row }) => {
	...
	{
		accessorKey: "isMain",
		header: ({ column }) => <DataGridColumnHeader column={column} title="Principal" visibility />,
		meta: {
