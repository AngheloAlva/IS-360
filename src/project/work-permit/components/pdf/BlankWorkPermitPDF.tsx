...
const BlankWorkPermitPDF = (): React.ReactElement => {
	return (
		<Document>
			...
			{/* Página de actividades (plantilla en blanco) */}
			<Page size="A4" style={styles.page}>
				{/* Encabezado */}
				<View style={styles.header}>
					<View style={{ flexDirection: "row", alignItems: "center" }}>
				...
				{/* Tabla de actividades en blanco */}
				<View style={styles.activitiesTable}>
					...
					{Array.from({ length: 5 }, (_, index) => (
						<View style={styles.activitiesRow} key={index}>
				...
				{/* Firmas */}
				<View style={{ marginBottom: 4, fontSize: 7, color: "#374151" }}>
					<Text>
