		...
		<div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
			<Link href="/dashboard/colaboradores">
				<Card className="cursor-pointer overflow-hidden border-none pt-0 transition-all hover:scale-105">
					<div className="bg-linear-to-br from-orange-600 to-red-700 p-1.5" />
			...
			<Link href="/dashboard/vehiculos">
				<Card className="cursor-pointer overflow-hidden border-none pt-0 transition-all hover:scale-105">
					<div className="bg-linear-to-br from-emerald-600 to-teal-700 p-1.5" />
					<CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
			...
			<Link href="/dashboard/libro-de-obras">
				<Card className="cursor-pointer overflow-hidden border-none pt-0 transition-all hover:scale-105">
					<div className="bg-linear-to-br from-blue-600 to-indigo-700 p-1.5" />
					<CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
			...
			<Link href="/dashboard/permiso-de-trabajo">
				<Card className="cursor-pointer overflow-hidden border-none pt-0 transition-all hover:scale-105">
					<div className="bg-linear-to-br from-purple-600 to-indigo-700 p-1.5" />
					<CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
		...
		<div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
			{[...Array(4)].map((_, i) => (
				<Card key={`card-skeleton-1-${i}`} className="overflow-hidden border-none pt-0 shadow-md">
					<div className="bg-linear-to-br from-gray-200 to-gray-300 p-1 dark:from-gray-700 dark:to-gray-800" />
					<CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
