	...
	if (!equipmentId) {
		return (
			<div className="flex h-[500px] flex-col items-center justify-center text-center">
				...
				<h3 className="text-xl font-semibold text-gray-700">Selecciona un equipo</h3>
	...
	if (!equipment) {
		return (
			<div className="flex h-[500px] flex-col items-center justify-center text-center">
				...
				<h3 className="text-xl font-semibold text-gray-700">Equipo no encontrado</h3>
				...
				<div className="flex-1 space-y-4">
					...
					<div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
						...
						<div className="flex items-center gap-2">
							...
							<span className="text-sm text-gray-600">{location?.path ?? "—"}</span>
						</div>
						<div className="flex items-center gap-2">
						...
						<div className="flex items-center gap-2">
							...
							<span className="text-sm font-semibold">Creado:</span>
						...
						<CardContent className="space-y-4">
							<div className="grid grid-cols-1 gap-4 md:grid-cols-2">
								<div className="space-y-2 rounded-lg border p-4">
									<div className="flex items-center gap-2">
										...
										<h3 className="font-semibold">Equipos Hijos</h3>
									</div>
							...
							{parentId && (
								<div className="rounded-lg border p-4">
									<div className="flex items-center gap-2">
										<HardDriveIcon className="h-5 w-5 text-emerald-600" />
										<h3 className="font-semibold">Equipo Padre</h3>
									</div>
							...
							{criticality && (
								<div className="rounded-lg border p-4">
									<div className="flex items-center gap-2">
										...
										<h3 className="font-semibold">Criticidad</h3>
									</div>
				...
				<TabsContent value="work-orders" className="mt-4">
					<Card>
						<CardHeader>
							...
							<CardDescription>Últimas órdenes de trabajo asociadas a este equipo</CardDescription>
						</CardHeader>
						<CardContent>
							<ScrollArea className="h-[300px]">
								{isLoadingWorkOrders ? (
										...
										{workOrders.map((workOrder) => (
											...
											>
												...
												<div className="flex-1">
													<div className="flex items-center justify-between">
														<h3 className="font-semibold">OT #{workOrder.otNumber}</h3>
														<Badge
															variant={
									...
									<div className="flex flex-col items-center justify-center py-8 text-center">
										...
										<h3 className="text-lg font-semibold">No hay órdenes de trabajo</h3>
										<p className="text-sm text-gray-500">
								...
								{isLoadingMaintenancePlans ? (
									...
									<div className="space-y-3">
										{maintenancePlans.map((plan) => (
											<div key={plan.id} className="flex items-center gap-3 rounded-md border p-3">
