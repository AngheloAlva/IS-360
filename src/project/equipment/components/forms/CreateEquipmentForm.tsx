...
export default function CreateEquipmentForm({
	...
	const form = useForm<EquipmentSchema>({
		...
		defaultValues: {
			...
			description: "",
			parentId: defaultParentId ?? parentId,
			isOperational: true,
	...
	return (
		<Sheet open={open} onOpenChange={setOpen}>
			{trigger ? (
				...
				<SheetTrigger
					className="flex h-10 cursor-pointer items-center justify-center gap-1.5 rounded-md bg-white px-3 text-sm font-semibold text-emerald-600 transition-all hover:scale-105"
