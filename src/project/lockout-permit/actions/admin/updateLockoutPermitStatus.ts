...
import { ACTIVITY_TYPE, MODULES, LOCKOUT_PERMIT_STATUS } from "@/generated/prisma/enums"
...
export async function updateLockoutPermitStatus(
	data: z.infer<typeof updateLockoutPermitStatusSchema>
) {
