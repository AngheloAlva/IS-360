								...
								<Card>
									...
									<CardContent className="grid grid-cols-1 gap-4 md:grid-cols-2">
										<div className="flex flex-col space-y-2">
											<label className="text-muted-foreground text-sm font-semibold">Estado</label>
											<Badge
										...
										<div className="space-y-2">
											<label className="text-muted-foreground text-sm font-semibold">Empresa</label>
											<div className="flex items-center gap-2">
													...
													<div key={registration.id} className="rounded-lg border p-4">
														<div className="mb-3 flex items-center justify-between">
															...
															<div className="text-muted-foreground text-sm">
																Candado:{" "}
																<span className="font-semibold">{registration.lockNumber}</span>
															</div>
														</div>
														...
														<div className="grid grid-cols-1 gap-4 md:grid-cols-2">
															<div className="space-y-2">
																<h5 className="font-semibold text-green-700">Instalación</h5>
															...
															<div className="space-y-2">
																<h5 className="font-semibold text-red-700">Retiro</h5>
																<div className="grid grid-cols-2 gap-2 text-sm">
																	<div>
																		<span className="text-muted-foreground">Fecha:</span>
																		<p>
