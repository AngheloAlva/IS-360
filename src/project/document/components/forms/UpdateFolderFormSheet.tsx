...
export default function UpdateFolderFormSheet({
	...
	return (
		<Sheet open={open} onOpenChange={setOpen}>
			<SheetTrigger
				className="flex w-full items-center justify-center gap-1 rounded-md bg-cyan-500 px-3 text-sm text-white hover:bg-cyan-500/80 dark:bg-cyan-700 dark:hover:bg-cyan-800"
