...
export default function NewFolderForm({
	...
	return (
		<Sheet open={open} onOpenChange={setOpen}>
			<SheetTrigger
				className="flex h-9 items-center justify-center gap-1 rounded-md bg-blue-500 px-3 text-sm tracking-wide text-white transition-all hover:scale-105 hover:bg-blue-600 dark:bg-blue-700 dark:hover:bg-blue-800"
