						...
						preview && (
							<div className="space-y-2">
								...
								{preview.folders.length > 0 && (
									<div>
										<span className="font-semibold">Carpetas ({preview.folders.length}):</span>
								...
								{preview.files.length > 0 && (
									<div>
										<span className="font-semibold">Archivos ({preview.files.length}):</span>
										<ul className="list-disc pl-6">
								...
								<p className="text-muted-foreground mt-4 text-sm">
									Esta acción no eliminará permanentemente los elementos, pero ya no serán listados.
								</p>
							</div>
						)
					)}
