...
export const WorkRequestStatusUpdateEmail = ({
	...
	status,
	description,
}: WorkRequestStatusUpdateEmailProps): React.ReactElement => (
	<Html>
		<Tailwind>
			<Head>
				...
				<Container className="mx-auto max-w-[600px] rounded-[8px] bg-white shadow-lg">
					...
					<Section className="px-[40px] py-[32px]">
						<Heading className="mb-[24px] text-center text-[28px] font-bold text-gray-800">
							Actualización de Solicitud de Trabajo
						</Heading>

						<Text className="mb-[24px] text-[16px] leading-[24px] text-gray-600">
							Hola {userName}, te informamos que tu solicitud de trabajo ha sido actualizada.
						...
						<Text className="text-[14px] leading-[20px] text-gray-600">
							Si tienes alguna duda sobre el estado de tu solicitud, contacta a tu supervisor o
							al equipo de soporte. Estamos aquí para ayudarte.
						</Text>
					</Section>
