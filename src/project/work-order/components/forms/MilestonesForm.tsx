...
interface MilestonesFormProps {
	...
	tutorialDefaultMilestones?: WorkBookMilestonesSchema["milestones"]
	onTutorialSubmit?: (values: WorkBookMilestonesSchema) => void
	...
	const onSubmit = async (values: WorkBookMilestonesSchema) => {
		try {
			...
			if (tutorialMode) {
				...
				toast.success("Hitos guardados en modo tutorial")
				setOpen(false)
				return
			}
	...
	return (
		<Sheet open={open} onOpenChange={setOpen}>
			...
			<SheetContent
				...
				className="w-full gap-0 sm:max-w-[70dvw] lg:max-w-[50dvw]"
			>
					...
					>
						...
						{milestoneFields.some(
							...
							<div className="rounded-md border border-amber-300 bg-amber-50 p-3 text-sm text-amber-800">
								<p className="font-semibold">Advertencias de fechas:</p>
						...
						<div data-tutorial-id={submitDataTutorialId}>
							<SubmitButton
