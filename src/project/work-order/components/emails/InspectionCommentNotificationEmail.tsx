				...
				<Body className="mx-auto my-auto bg-white px-2 font-sans">
					<Container className="mx-auto my-[40px] max-w-[465px] rounded border border-solid border-[#eaeaea] p-[20px]">
						<Section className="mt-[32px]">
							<Img
								src="https://is360.blob.core.windows.net/files/logo.png"
								width="40"
								height="37"
								alt="IS 360"
						...
						<Section className="my-4 rounded-lg bg-gray-50 p-4">
							<Row>
								...
								<Column align="right">
									<Text
										className="m-0 rounded px-2 py-1 text-[12px] font-semibold"
										style={{
						...
						<Section className="my-4 rounded-lg bg-blue-50 p-4">
							...
							{inspection.isResolved && (
								<Text
									className="m-0 mt-2 rounded px-2 py-1 text-[12px] font-semibold"
									style={{
						...
						<Text className="text-[12px] leading-[24px] text-[#666666]">
							Este correo fue enviado automáticamente desde el sistema interno. Por favor no responder a
