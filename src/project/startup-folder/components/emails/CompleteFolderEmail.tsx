...
export const CompleteFolderEmail: React.FC<Readonly<ReviewEmailTemplateProps>> = async ({
	folderName,
	companyName,
}) => {
	return (
		<Html>
			<Tailwind>
				<Head>
					<title>La carpeta {folderName} ha sido completada - OTC 360</title>
					<Preview>La carpeta {folderName} ha sido completada por OTC</Preview>
				</Head>
