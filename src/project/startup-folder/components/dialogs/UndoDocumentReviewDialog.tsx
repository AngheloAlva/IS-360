	...
	const handleSubmit = async () => {
		...
		try {
			...
			if (category === "SAFETY_AND_HEALTH") {
				...
				result = await undoWorkerDocumentReview({ documentIds })
				...
				result = await undoEnvironmentalDocumentReview({ documentIds })
				...
				result = await undoEnvironmentDocumentReview({ documentIds })
