...
export function DocumentReviewForm({
	...
	const [approvalStatus, setApprovalStatus] = useState<
		"APPROVED" | "REJECTED" | "NOT_APPLIED" | null
	>(null)
						...
						: "Documento rechazado",
				{
					description:
						approvalStatus === "APPROVED"
							...
							: approvalStatus === "NOT_APPLIED"
								? "El documento ha sido marcado como No Aplica correctamente"
				...
				<form onSubmit={onSubmit} className="space-y-4">
					<div className="space-y-2 py-4">
						<RadioGroup
							...
							onValueChange={(value) =>
								setApprovalStatus(value as "APPROVED" | "REJECTED" | "NOT_APPLIED")
							}
						...
						>
							...
							<div className="flex items-center space-x-2">
								<RadioGroupItem value="NOT_APPLIED" id="not-applied" />
								<Label htmlFor="not-applied" className="flex cursor-pointer items-center">
									Marcar como No Aplica
									<BanIcon className="text-muted-foreground mr-1 h-4 w-4" />
								</Label>
							</div>
					...
					<DialogFooter className="flex justify-end pt-4">
						...
						<Button
							...
							className={cn("bg-emerald-600 hover:bg-emerald-700", {
								...
								"bg-slate-600 hover:bg-slate-700": approvalStatus === "NOT_APPLIED",
							})}
						>
