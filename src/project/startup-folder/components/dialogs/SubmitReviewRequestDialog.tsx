	...
	return (
		<Dialog open={open} onOpenChange={setOpen}>
			<DialogTrigger asChild>
				<Button className="ml-2 gap-2 bg-emerald-500 text-white transition-all hover:scale-105 hover:bg-emerald-600 hover:text-white dark:bg-emerald-700 dark:hover:bg-emerald-800">
