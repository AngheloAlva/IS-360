	...
	return (
		<Dialog open={open} onOpenChange={setOpen}>
			<DialogTrigger asChild>
				<Button size="icon" variant="ghost" className="text-purple-500 hover:text-purple-500">
					<CalendarSyncIcon className="h-4 w-4" />
				</Button>
			</DialogTrigger>

			<DialogContent>
				<DialogHeader className="shadow">
					<DialogTitle>Actualizar fecha de vencimiento</DialogTitle>
					<DialogDescription>
						Actualiza la fecha de vencimiento del documento seleccionado
					</DialogDescription>
				</DialogHeader>
					...
					<form onSubmit={form.handleSubmit(onSubmit)} className="flex flex-col gap-y-6">
						...
						<div className="flex justify-end gap-x-2">
							...
							<SubmitButton
								...
								className="h-9 w-fit bg-purple-500 hover:bg-purple-600"
							/>
						</div>
					</form>
				</Form>
