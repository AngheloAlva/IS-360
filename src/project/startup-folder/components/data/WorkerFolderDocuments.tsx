...
import WorkerFolderConfigDialog from "../dialogs/WorkerFolderConfigDialog"
...
import { WorkerSafetyTalksSection } from "./WorkerSafetyTalksSection"
...
import type { WorkerDocumentType } from "@/generated/prisma/enums"
...
export function WorkerFolderDocuments({
	...
	return (
         ...
         void queryClient.invalidateQueries({
					...
					{isOtcMember && data?.folderStatus && (
						<WorkerFolderConfigDialog
							...
							currentIsDriver={data?.isDriver ?? true}
							onSuccess={async () => {
        void queryClient.invalidateQueries({
        ...
        void queryClient.invalidateQueries({
			...
			<WorkerSafetyTalksSection workerId={workerId} workerName={workerName} />
