...
interface WorkerSafetyTalksSectionProps {
	workerId: string
	workerName: string
}
...
export function WorkerSafetyTalksSection({ workerId, workerName }: WorkerSafetyTalksSectionProps) {
  ...
  void fetchSafetyTalks()
	...
	return (
		<Card>
			<CardHeader>
				<CardTitle>Charlas de Seguridad</CardTitle>
				<CardDescription>Estado de las charlas de seguridad de {workerName}</CardDescription>
			</CardHeader>
			<CardContent>
				{loading ? (
