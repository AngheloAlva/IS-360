		...
		try {
			...
			const worksheet = XLSX.utils.json_to_sheet(
				res.data.map((safetyTalk: ApiSafetyTalk) => {
					const userData = safetyTalk.isExternal ? safetyTalk.externalVisitor : safetyTalk.user
					return {
						"Nombre": userData?.name || "N/A",
						"RUT": userData?.rut || "N/A",
						"Empresa": userData?.company?.name || "Sin empresa",
						"Tipo": safetyTalk.isExternal ? "Externo" : "Interno",
