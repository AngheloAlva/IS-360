...
export default function ExternalCompanyForm(): React.ReactElement {
	...
	async function onSubmit(values: ExternalCompanySchema) {
		...
		try {
			const videoUrl =
				values.category === "VISITOR"
					? "https://drive.google.com/file/d/1E4DVzsswWu2GfXNGqRTdAgIjWPLt1Zty/preview"
					: "https://drive.google.com/file/d/18JdWOulPeWZ3nlNQbTRm6-KLCvIrJ0kO/preview"
					...
					>
								...
								render={({ field }) => (
									<FormItem>
										...
										<Select onValueChange={field.onChange} defaultValue={field.value}>
											...
											<SelectContent>
												<SelectItem value="VISITOR_TRM">Inducción Visitas El Avellano</SelectItem>
												<SelectItem value="VISITOR">Inducción Visitas Hualpén</SelectItem>
											</SelectContent>
										</Select>
										<FormMessage />
									</FormItem>
						...
						<div className="flex justify-end pt-4">
							<SubmitButton
								...
								label="Crear y Compartir Charla"
