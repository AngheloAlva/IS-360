...
interface LaborControlFolderStatusBadgeProps {
	status: LABOR_CONTROL_STATUS | "NOT_UPLOADED"
	className?: string
}

export function LaborControlFolderStatusBadge({
	status,
	className,
}: LaborControlFolderStatusBadgeProps) {
	const statusMap = {
		NOT_UPLOADED: {
			label: "No subido",
		...
		NOT_APPLIED: {
			label: "No aplica",
			className: "bg-slate-600/20 text-slate-800 dark:bg-slate-400/20 dark:text-slate-200",
		},
	}
