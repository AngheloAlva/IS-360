			...
			<CardContent className="flex w-full flex-col items-start gap-4">
				<div className="flex w-full flex-wrap items-center gap-2 md:w-full md:flex-row">
					...
					<SearchInput
						...
						className="ml-auto w-full md:w-56"
					...
					>
						<SelectTrigger className="border-input bg-background hover:bg-input w-full border transition-colors sm:w-fit">
							{filters.onlyWithReviewRequest ? "Con solicitud de revisión" : "Todas las empresas"}
						</SelectTrigger>
						<SelectContent>
							<SelectGroup>
								<SelectLabel>¿Con solicitud de revisión?</SelectLabel>
								<SelectSeparator />
								<SelectItem value="false">Todas las empresas</SelectItem>
								<SelectItem value="true">Con solicitud de revisión</SelectItem>
							</SelectGroup>
						</SelectContent>
					</Select>
					...
					<Button
						...
						className="size-9 border-blue-600 text-blue-600 hover:bg-blue-600 hover:text-white"
					>
						<FilterXIcon />
					</Button>
